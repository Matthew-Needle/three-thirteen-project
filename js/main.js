...
const change = () => {
  ...
  const d = document.getElementById("name-input-c").value;
  const e = document.getElementById("name-input-c").value;
  const f = document.getElementById("name-input-c").value;
